...
func Tenantaccessgit_regenerateprimarykeyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/subscriptions/%s/resourceGroups/%s/providers/Microsoft.ApiManagement/service/%s/tenant/%s/git/regeneratePrimaryKey%s", cfg.BaseURL, resourceGroupName, serviceName, subscriptionId, accessName, queryString)
...
func CreateTenantaccessgit_regenerateprimarykeyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_tenant_accessName_git_regeneratePrimaryKey",
		mcp.WithDescription("Regenerate primary access key for GIT."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Tenantaccessgit_regenerateprimarykeyHandler(cfg),
	}
}
