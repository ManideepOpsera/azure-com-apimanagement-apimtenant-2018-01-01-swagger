...
func Tenantaccess_getHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/subscriptions/%s/resourceGroups/%s/providers/Microsoft.ApiManagement/service/%s/tenant/%s%s", cfg.BaseURL, resourceGroupName, serviceName, subscriptionId, accessName, queryString)
...
func CreateTenantaccess_getTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_tenant_accessName",
		mcp.WithDescription("Get tenant access information details."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Tenantaccess_getHandler(cfg),
	}
}
