...
func Tenantaccess_regeneratesecondarykeyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/subscriptions/%s/resourceGroups/%s/providers/Microsoft.ApiManagement/service/%s/tenant/%s/regenerateSecondaryKey%s", cfg.BaseURL, resourceGroupName, serviceName, subscriptionId, accessName, queryString)
...
func CreateTenantaccess_regeneratesecondarykeyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_tenant_accessName_regenerateSecondaryKey",
		mcp.WithDescription("Regenerate secondary access key."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Tenantaccess_regeneratesecondarykeyHandler(cfg),
	}
}
