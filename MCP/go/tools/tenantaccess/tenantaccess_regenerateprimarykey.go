...
func Tenantaccess_regenerateprimarykeyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/subscriptions/%s/resourceGroups/%s/providers/Microsoft.ApiManagement/service/%s/tenant/%s/regeneratePrimaryKey%s", cfg.BaseURL, resourceGroupName, serviceName, subscriptionId, accessName, queryString)
...
func CreateTenantaccess_regenerateprimarykeyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_tenant_accessName_regeneratePrimaryKey",
		mcp.WithDescription("Regenerate primary access key."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Tenantaccess_regenerateprimarykeyHandler(cfg),
	}
}
